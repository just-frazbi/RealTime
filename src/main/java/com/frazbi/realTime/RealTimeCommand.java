    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "status":
                ...
                ZonedDateTime zonedNow = ZonedDateTime.now(plugin.getTimeZone());
                ...
                sender.sendMessage(ChatColor.YELLOW + "Часовой пояс: " + ChatColor.WHITE + plugin.getTimeZone().getId());
                sender.sendMessage(ChatColor.YELLOW + "Реальное время: " + ChatColor.WHITE + zonedNow.format(formatter));
                return true;
